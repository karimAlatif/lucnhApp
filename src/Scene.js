...
var backroundAudio = require(`./assets/sounds/test.ogg`);
...
class Scene extends Component {
  ...
  initEnvironment () {
   ...
   // Orbitcontrols
    ...
    this.orbitControls.maxPolarAngle = Math.PI/2; // mouse sensitivity
    this.orbitControls.minPolarAngle = Math.PI/2; // mouse sensitivity
   ...
   let planetTexture = require("./assets/imgs/planets/2k_earth_daymap.jpg");
   let planetTextureN = require("./assets/imgs/planets/2k_earth_normal_map.tif");
  ...
  //  audioLoader.load(backroundAudio, function  ( buffer ) {  
  //    console.log("Sdsd")
